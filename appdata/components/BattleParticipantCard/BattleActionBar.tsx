...
const BattleActionBar: React.FC<BattleActionBarProps> = ({ actionBarProgress, actionBarReadyClass, participantName, initialAttackCooldown, attackCooldown }) => {
  return (
    <div 
      className="w-full bg-slate-600 rounded-full h-1 mb-0.5" 
      role="progressbar" 
    ...
    >
      <div
        className={`bg-cyan-400 h-1 rounded-full transition-all duration-100 ease-linear ${actionBarReadyClass}`} 
