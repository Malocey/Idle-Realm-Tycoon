...
export const WAVES_11_20: WaveDefinition[] = [
  ...
  { id: 'wave_12', waveNumber: 12, enemies: [{ enemyId: 'SKELETON_MAGE', count: 1 }, { enemyId: 'CORPSEBLOOM_SPROUT', count: 1 }, { enemyId: 'ARMORED_GOBLIN', count: 1}, { enemyId: 'BANDIT_MARKSMAN', count: 1 }, { enemyId: 'SHIELD_MENDER_GOBLIN', count: 1 }], reward: [{ resource: ResourceType.GOLD, amount: 400 }, { resource: ResourceType.HEROIC_POINTS, amount: 90 }] },
  { id: 'wave_13', waveNumber: 13, enemies: [{ enemyId: 'SKELETON_ARCHER', count: 3 }, { enemyId: 'SKELETON_WARRIOR', count: 2 }, {enemyId: 'GIANT_SPIDER', count: 3}, { enemyId: 'SHIELD_MENDER_GOBLIN', count: 2 }], reward: [{ resource: ResourceType.GOLD, amount: 450 }, { resource: ResourceType.WOOD, amount: 20 }, { resource: ResourceType.STONE, amount: 10 }, { resource: ResourceType.HEROIC_POINTS, amount: 100 }] },
  { id: 'wave_14', waveNumber: 14, enemies: [{ enemyId: 'ORC_BRUTE', count: 2 }, { enemyId: 'DIRE_WOLF', count: 1 }, { enemyId: 'CORPSEBLOOM_SPROUT', count: 2 }, { enemyId: 'IMP_WARLOCK', count: 1 }, { enemyId: 'SHIELD_MENDER_GOBLIN', count: 1 }], reward: [{ resource: ResourceType.GOLD, amount: 500 }, { resource: ResourceType.IRON, amount: 10 }, { resource: ResourceType.HEROIC_POINTS, amount: 120 }] },
  { id: 'wave_15', waveNumber: 15, enemies: [{ enemyId: 'GOBLIN', count: 4 }, { enemyId: 'SKELETON_ARCHER', count: 3 }, { enemyId: 'SKELETON_WARRIOR', count: 1}, { enemyId: 'ARCANE_SENTRY', count: 1 }, { enemyId: 'SHIELD_MENDER_GOBLIN', count: 2 }], reward: [{ resource: ResourceType.GOLD, amount: 550 }, { resource: ResourceType.CRYSTALS, amount: 10 }, { resource: ResourceType.META_CURRENCY, amount: 1 }, { resource: ResourceType.HEROIC_POINTS, amount: 150 }, { resource: ResourceType.CATACOMB_BLUEPRINT, amount: 1}] },
  { id: 'wave_16', waveNumber: 16, enemies: [{ enemyId: 'ORC_BRUTE', count: 2 }, { enemyId: 'SKELETON_WARRIOR', count: 2 }, { enemyId: 'DIRE_WOLF', count: 1 }, { enemyId: 'CORPSEBLOOM_SPROUT', count: 1 }, { enemyId: 'ARCANE_RESTORER', count: 1 }], reward: [{ resource: ResourceType.GOLD, amount: 600 }, { resource: ResourceType.IRON, amount: 7 }, { resource: ResourceType.CRYSTALS, amount: 7 }, { resource: ResourceType.HEROIC_POINTS, amount: 160 }] },
  { id: 'wave_17', waveNumber: 17, enemies: [{ enemyId: 'GIANT_SPIDER', count: 6 }, { enemyId: 'ORC_BRUTE', count: 2 }, { enemyId: 'SHIELD_MENDER_GOBLIN', count: 2 }, { enemyId: 'ARCANE_RESTORER', count: 1 }], reward: [{ resource: ResourceType.GOLD, amount: 650 }, { resource: ResourceType.LEATHER, amount: 10 }, { resource: ResourceType.HEROIC_POINTS, amount: 170 }] },
  { id: 'wave_18', waveNumber: 18, enemies: [{ enemyId: 'DIRE_WOLF', count: 3 }, { enemyId: 'SKELETON_WARRIOR', count: 2 }, { enemyId: 'CORPSEBLOOM_SPROUT', count: 2 }, { enemyId: 'ARCANE_RESTORER', count: 1 }], reward: [{ resource: ResourceType.GOLD, amount: 700 }, { resource: ResourceType.IRON, amount: 15 }, { resource: ResourceType.HEROIC_POINTS, amount: 200 }, { resource: ResourceType.CATACOMB_BLUEPRINT, amount: 1}] },
  { id: 'wave_19', waveNumber: 19, enemies: [{ enemyId: 'SKELETON_ARCHER', count: 4 }, { enemyId: 'ORC_BRUTE', count: 2 }, { enemyId: 'GIANT_SPIDER', count: 3 }, { enemyId: 'SHIELD_MENDER_GOBLIN', count: 1 }, { enemyId: 'ARCANE_RESTORER', count: 1 }], reward: [{ resource: ResourceType.GOLD, amount: 750 }, { resource: ResourceType.CRYSTALS, amount: 15 }, { resource: ResourceType.HEROIC_POINTS, amount: 220 }] },
  { 
    id: 'wave_20',
    waveNumber: 20, 
