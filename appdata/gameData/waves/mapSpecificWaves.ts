...
export const MAP_GOBLIN_CAMP_WAVES: WaveDefinition[] = [
  ...
  },
  {
    ...
    reward: [{ resource: ResourceType.WOOD, amount: 25 }, { resource: ResourceType.GOLD, amount: 40 }, { resource: ResourceType.IRON, amount: 2 }, { resource: ResourceType.HEROIC_POINTS, amount: 10 }]
  },
  {
    ...
    reward: [{ resource: ResourceType.WOOD, amount: 30 }, { resource: ResourceType.GOLD, amount: 50 }, { resource: ResourceType.IRON, amount: 3 }, { resource: ResourceType.HEROIC_POINTS, amount: 12 }]
  },
  {
  ...
  },
  {
    ...
    reward: [{ resource: ResourceType.FOOD, amount: 20 }, { resource: ResourceType.GOLD, amount: 35 }, { resource: ResourceType.LEATHER, amount: 2 }, { resource: ResourceType.HEROIC_POINTS, amount: 9 }]
  },
  {
