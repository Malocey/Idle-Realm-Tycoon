...
export const AUTOBATTLER_WORLD_HEIGHT = AUTOBATTLER_VIEWPORT_HEIGHT * 1.25; // Example: 420 * 1.25 = 525, can be same as viewport height if no vertical scroll intended for battle path
...
export const PLAYER_GRID_CELL_HEIGHT_PX = AUTOBATTLER_VIEWPORT_HEIGHT / PLAYER_BUILDING_GRID_ROWS; // 420 / 12 = 35 // Keep consistent with viewport height for grid cell calculation
...
export const AUTOBATTLER_BATTLE_PATH_WIDTH = AUTOBATTLER_WORLD_WIDTH - PLAYER_GRID_DISPLAY_WIDTH - 100; // Example dynamic battle path width